// Magdalena Wollin
// M4-assignment - 01-coinflip-redux
...
times2Flip = prompt('How many times do you want to flip the coin?');

//document.write(`Times to flip the coin : ${times2Flip}<br>`);
//loop
for (let i = 0; i < times2Flip; i++) {
    //get random number 0 or 1
    coinFlip = Math.round(Math.random() * 1);
    //document.write(`Coined result : ${coinFlip}<br>`);
    if (coinFlip == 1) {
